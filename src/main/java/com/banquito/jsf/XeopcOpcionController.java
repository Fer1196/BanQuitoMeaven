...
import com.banquito.controladores.XeopcOpcionFacade;
...
public class XeopcOpcionController implements Serializable {
    ...
    @EJB
    private com.banquito.controladores.XeopcOpcionFacade ejbFacade;
    ...
    public static class XeopcOpcionControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof XeopcOpcion) {
                ...
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), XeopcOpcion.class.getName()});
                return null;
            }
        }
