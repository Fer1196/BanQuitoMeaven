...
import com.banquito.controladores.XeusuUsuarFacade;
...
public class XeusuUsuarController implements Serializable {
    ...
    @EJB
    private com.banquito.controladores.XeusuUsuarFacade ejbFacade;
    ...
    public void create() {
        selected.setXeusuPassword(selected.generateRandomText());
