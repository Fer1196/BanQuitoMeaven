...
import com.banquito.controladores.PecarCargoFacade;
...
public class PecarCargoController implements Serializable {
    ...
    @EJB
    private com.banquito.controladores.PecarCargoFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setPecarCargoPK(new com.banquito.jpa.PecarCargoPK());
    }
    ...
    public PecarCargo getPecarCargo(com.banquito.jpa.PecarCargoPK id) {
    ...
    public static class PecarCargoControllerConverter implements Converter {
        ...
        com.banquito.jpa.PecarCargoPK getKey(String value) {
            com.banquito.jpa.PecarCargoPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.banquito.jpa.PecarCargoPK();
            key.setPedepCodigo(values[0]);
            key.setPecarCodigo(values[1]);
            return key;
        }

        String getStringKey(com.banquito.jpa.PecarCargoPK value) {
